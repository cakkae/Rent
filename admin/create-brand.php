...
{
$brand=$_POST['brand']; $privilegija = $_POST['privilegija'];
//$sql="INSERT INTO  tblbrands(BrandName, privilegija) VALUES(:brand,	:kor)";
$sql = "INSERT INTO tblbrands(BrandName, privilegija) VALUES ('".$_POST["brand"]."','".$_POST["privilegija"]."')";
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Dodaj brend</h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>GREŠKA</strong>:<?php echo htmlentities($error); ?> </div><?php }
						...
						<div class="form-group">
												<label class="col-sm-4 control-label">Naziv brenda</label>
												<div class="col-sm-8">
		<input type="text" class="form-control" name="brand" id="brand" required></div>
		</div>
