...
$msg="Pohvala uspješno arhivirana";
}
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Upravljanje upitima</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Upiti</div>
...
<td><a href="manage-conactusquery.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Da li želite pročitati?')" >Čekanje</a>
	</td>
<?php } ?>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
