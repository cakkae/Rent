...
<head>
	...
	<title>liliRENT | Uređivanje automobila</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Izmijena automobila</h2>
...
<?php if($msg){?><div class="succWrap"><strong>USPJEŠNO</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
<?php 
$id=intval($_GET['id']);
...
<label class="col-sm-2 control-label">Naziv<span style="color:red"></span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" >
</div>
<label class="col-sm-2 control-label">Odaberite brend<span style="color:red"></span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Pregled vozila<span style="color:red"></span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Cijena po danu<span style="color:red"></span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" >
</div>
<label class="col-sm-2 control-label">Odaberite tip goriva<span style="color:red"></span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Godište<span style="color:red"></span></label>
<div class="col-sm-4">
<input type="text" name="modelyear" class="form-control" value="<?php echo htmlentities($result->ModelYear);?>" >
</div>
<label class="col-sm-2 control-label">Broj sjedišta<span style="color:red"></span></label>
<div class="col-sm-4">
...
<div class="form-group">
<div class="col-sm-4">
Slika 1 <img src="img/vehicleimages/<?php echo htmlentities($result->Vimage1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Promijeni sliku 1</a>
</div>
<div class="col-sm-4">
Slika 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Promijeni sliku 2</a>
</div>
<div class="col-sm-4">
Slika 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage3.php?imgid=<?php echo htmlentities($result->id)?>">Promijeni sliku 3</a>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Slika 4<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage4);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Promijeni sliku 4</a>
</div>
<div class="col-sm-4">
Slika 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Promijeni sliku 5</a>
<?php } ?>
</div>
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Dodatna oprema</div>
<div class="panel-body">
...
<label for="powerdoorlocks"> Daljinsko zaključavanje vrata </label>
</div>
<?php } else {?>
...
<label for="brakeassist"> Pomoć pri kočenju </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="powersteering"> Tempomat </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="driverairbag">Zračni jastuk vozača</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="passengerairbag"> Zračni jastuk putnika	 </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="centrallocking">Centralno zaključavanje</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
...
<label for="crashcensor"> Senzor pri parkiranju </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="leatherseats"> Kožna sjedišta </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2" >
													...
													<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Snimi promjene</button>
												</div>
											</div>
