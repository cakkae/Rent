...
<title>liliRENT | Vaše pohvalnice</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Postavi pohvalnicu</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="#">Početna</a></li>
        <li>Postavi pohvalnicu</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Postavi pohvalnicu</h5>
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Pohvalnice</label>
              <textarea class="form-control white_bg" name="testimonial" rows="4" required=""></textarea>
            </div>
          
           
            <div class="form-group">
              <button type="submit" name="submit" class="btn">Snimi  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
